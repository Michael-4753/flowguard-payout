...
export const HACK_DECK: HackSlide[] = [
  {
    ...
    lead: "FlowGuard 是一款面向外贸工贸企业与跨境服务商的 AI 驱动跨境结算决策辅助平台，专注于付款前合规风险预检、多持牌通道智能路由、结算链路透明化追踪与全流程凭证智能对账，帮助企业降低汇款退回风险、消除中间行信息黑箱、提升跨国结算与财务对账效率。",
  ...
  },
  {
    ...
    pages: [
      { name: "首页 · 付款控制台", body: "待办付款、进行中笔数与整体退回风险一屏概览，是进入各流程的入口。" },
      { name: "付款 · 新建付款向导", body: "录入收款方 → 退回预检 → 多通道比价选路 → 双人放行，一步步生成付款指令。" },
      { name: "收款人 · 收款人台账", body: "按国家分组的收款人，含 SWIFT/IBAN、可用通道与历史失败记录。" },
      { name: "审批 · 审批队列", body: "Maker-Checker：出纳提交的每笔指令在此等第二签批准，通过后才放行。" },
      { name: "工单 · 核实与退回案例", body: "跟踪收款人核实请求，并研究真实退回案例，沉淀为可复用经验。" },
