...
export const HACK_DECK: HackSlide[] = [
  ...
  },
  {
    ...
    pages: [
      { name: "首页 · 概览", body: "待办付款、进行中笔数与整体退回风险一屏概览，作为进入各流程的入口。" },
      { name: "付款向导 · 退回预检", body: "规则引擎给出退回概率与命中因子，AI 补充语义风险，先拦截而非先失败。" },
      { name: "付款向导 · 比价选路", body: "多持牌通道按费用/时效/退回率排序，AI 解释为什么推荐这条路径。" },
      { name: "结算对账看板", body: "逐跳追踪中间行、标注黑箱卡点，聚合进度凭证，自动核销并导出对账单。" },
      { name: "双人放行审批", body: "大额进入双人/多级复核，指令生成前留痕，责任可追溯——平台不经手资金。" },
      { name: "AI 核实工单 / 案例", body: "检查结论转通俗说明与修复步骤，一键生成核实工单，沉淀为可复用案例。" },
    ],
