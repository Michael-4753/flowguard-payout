...
export const HACK_DECK: HackSlide[] = [
  ...
  },
  {
    ...
    bullets: [
      { head: "先发后祈祷", body: "钱汇出去才知道会被退回——资金冻结数日，业务停摆、供应商催货。" },
      { head: "退回原因藏在细节", body: "收款人信息一个字段不符、通道选错，就整笔退回，出纳无从预判。" },
      { head: "选错通道白花钱", body: "稳定币直连 vs 本地法币凭感觉选，费用更高、失败率更高。" },
      { head: "缺少双人控制", body: "一个人又发起又确认，填错没有第二道拦截，直接造成损失。" },
    ],
