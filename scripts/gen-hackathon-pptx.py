...
add_text(s, Inches(1.5), Inches(4.85), Inches(10.3), Inches(1.4),
         "FlowGuard 是一款面向外贸工贸企业与跨境服务商的 AI 驱动跨境结算决策辅助平台，专注于付款前合规风险预检、多持牌通道智能路由、结算链路透明化追踪与全流程凭证智能对账，帮助企业降低汇款退回风险、消除中间行信息黑箱、提升跨国结算与财务对账效率。",
...
DEMO_PAGES = [
    ...
    ("付款 · 新建付款向导", "录入收款方 → 退回预检 → 多通道比价选路 → 双人放行，一步步生成付款指令。"),
    ("收款人 · 收款人台账", "按国家分组的收款人，含 SWIFT/IBAN、可用通道与历史失败记录。"),
    ("审批 · 审批队列", "Maker-Checker：出纳提交的每笔指令在此等第二签批准，通过后才放行。"),
    ("工单 · 核实与退回案例", "跟踪收款人核实请求，并研究真实退回案例，沉淀为可复用经验。"),
    ("历史 · 付款历史", "每一笔已选路付款及其预检快照与所选通道，全程可回溯。"),
]
...
DEMO_VIDEO = "/home/user/flowguard-payout/public/eazo-assets/att_5eunp0uemw6qhym7beo-demo-walkthrough.mp4"
rect(s, Inches(8.9), Inches(1.65), Inches(3.55), Inches(5.4), CARDBG)
if os.path.exists(DEMO_VIDEO):
    s.shapes.add_movie(DEMO_VIDEO, Inches(8.98), Inches(1.75), Inches(3.4), Inches(5.2),
                       mime_type="video/mp4")
    add_text(s, Inches(8.9), Inches(7.12), Inches(3.55), Inches(0.3), "Demo 视频（点击播放）", 9, MUT, align=PP_ALIGN.CENTER)
else:
